...
namespace DXApplication1.Vistas
{
    public partial class question7 : UserControl
    {
        ...
        private void Question7_Load(object sender, EventArgs e)
        {
            ...
            NpgsqlDataAdapter adapter = new NpgsqlDataAdapter("SELECT vii_facultad.valor, COUNT( * ) as cantidad FROM respuestas INNER JOIN vii_facultad ON respuestas.VII = vii_facultad.clave GROUP BY VII", dbConnection.Connection);
