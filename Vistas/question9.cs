...
namespace DXApplication1.Vistas
{
    ...
    {
        public question9() //Año de estudio
        {
            InitializeComponent();
        }
        ...
        private void Question9_Load(object sender, EventArgs e)
        {
            ...
            NpgsqlDataAdapter adapter = new NpgsqlDataAdapter("SELECT IX as valor, COUNT(*) as cantidad FROM respuestas GROUP BY IX", dbConnection.Connection);
