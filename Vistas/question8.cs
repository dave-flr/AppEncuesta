...
namespace DXApplication1.Vistas
{
    public partial class question8 : UserControl
    {
        ...
        private void Question8_Load(object sender, EventArgs e)
        {
            ...
            MySqlDataAdapter adapter = new MySqlDataAdapter("SELECT viii_carrera.valor, COUNT( * ) as cantidad FROM respuestas INNER JOIN viii_carrera ON respuestas.VIII = viii_carrera.clave GROUP BY VIII", dbConnection.Connection);
